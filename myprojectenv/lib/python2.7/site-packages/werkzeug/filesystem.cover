    ...
    1:     sys.platform.startswith('linux') or 'bsd' in sys.platform
       
       
    1: def _is_ascii_encoding(encoding):
           """
    ...
    2: class BrokenFilesystemWarning(RuntimeWarning, UnicodeWarning):
           '''The warning used by Werkzeug to signal a broken filesystem. Will only be
    1:     used once per runtime.'''
       
       
    1: _warned_about_filesystem_encoding = False
