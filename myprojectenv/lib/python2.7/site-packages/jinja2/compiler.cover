    ...
    1:     dict_item_iter = 'iteritems'
       else:
           dict_item_iter = 'items'
       
       
       # does if 0: dummy(x) get us x into the scope?
    1: def unoptimize_before_dead_code():
    1:     x = 42
    1:     def f():
               if 0: dummy(x)
    1:     return f
    ...
    1: unoptimize_before_dead_code = bool(
    1:     getattr(unoptimize_before_dead_code(), '__closure__', None))
       
       
    1: def generate(node, environment, name, filename, stream=None,
    1:              defer_init=False):
    ...
    2: class Identifiers(object):
    1:     """Tracks the status of identifiers in frames."""
    ...
    1:     def add_special(self, name):
               """Register a special name like `loop`."""
               self.undeclared.discard(name)
               self.declared.add(name)
       
    1:     def is_declared(self, name):
    ...
    1:     def __init__(self, eval_ctx, parent=None):
    ...
    1:     def find_shadowed(self, extra=()):
    ...
    2: class FrameIdentifierVisitor(NodeVisitor):
    1:     """A visitor for `Frame.inspect`."""
       
    1:     def __init__(self, identifiers):
               self.identifiers = identifiers
    ...
    1:     def visit_FromImport(self, node):
               self.generic_visit(node)
    ...
    1:     def visit_CallBlock(self, node):
               self.visit(node.call)
       
    1:     def visit_FilterBlock(self, node):
               self.visit(node.filter)
       
    1:     def visit_AssignBlock(self, node):
               """Stop visiting at block assigns."""
       
    1:     def visit_Scope(self, node):
    ...
    1:     def __init__(self, environment, name, filename, stream=None,
    1:                  defer_init=False):
               if stream is None:
    ...
    1:     def return_buffer_contents(self, frame):
    ...
    1:     def unoptimize_scope(self, frame):
    ...
    1:     def push_scope(self, frame, extra_vars=()):
    ...
    1:     def pop_scope(self, aliases, frame):
    ...
    1:     def function_scoping(self, node, frame, children=None,
    1:                          find_special=True):
    ...
    1:     def macro_body(self, node, frame, children=None):
    ...
    1:     def macro_def(self, node, frame):
    ...
    1:     def make_assignment_frame(self, frame):
    ...
    1:     def export_assigned_vars(self, frame, assignment_frame):
               if not frame.toplevel:
                   return
    ...
    1:     def visit_Concat(self, node, frame):
               if frame.eval_ctx.volatile:
    ...
    1:     def visit_Compare(self, node, frame):
    ...
    1:     def visit_Getattr(self, node, frame):
               self.write('environment.getattr(')
               self.visit(node.node, frame)
               self.write(', %r)' % node.attr)
       
    1:     def visit_Getitem(self, node, frame):
    ...
    1:     def visit_Filter(self, node, frame):
    ...
    1:     def visit_Test(self, node, frame):
    ...
    1:     def visit_CondExpr(self, node, frame):
               def write_expr2():
