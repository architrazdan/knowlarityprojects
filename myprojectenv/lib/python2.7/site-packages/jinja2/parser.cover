    ...
    1:     def __init__(self, environment, source, name=None, filename=None,
    1:                  state=None):
    ...
    1:     def parse_assign_target(self, with_tuple=True, name_only=False,
    1:                             extra_end_rules=None):
    ...
    1:     def parse_tuple(self, simplified=False, with_condexpr=True,
