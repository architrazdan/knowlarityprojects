    ...
    1: from jinja2._compat import text_type, string_types, implements_iterator, \
            url_quote
   ...
   16:     internal_code.add(f.__code__)
   16:     return f
    ...
    1: def urlize(text, trim_url_limit=None, nofollow=False, target=None):
    ...
    2:         self._popleft = self._queue.popleft
    2:         self._pop = self._queue.pop
    2:         self._remove = self._queue.remove
    2:         self._wlock = Lock()
    2:         self._append = self._queue.append
    ...
    1:     MutableMapping.register(LRUCache)
       except ImportError:
           pass
       
       
    2: @implements_iterator
    1: class Cycler(object):
    1:     """A cycle helper for templates."""
    ...
    1: from markupsafe import Markup, escape, soft_unicode
