    ...
    2: class _CompactJSON(object):
           """Wrapper around simplejson that strips whitespace.
    1:     """
       
    1:     def loads(self, payload):
    ...
    1: def want_bytes(s, encoding='utf-8', errors='strict'):
           if isinstance(s, text_type):
               s = s.encode(encoding, errors)
           return s
       
       
    1: def is_text_serializer(serializer):
    ...
    1: _builtin_constant_time_compare = getattr(hmac, 'compare_digest', None)
    ...
    1:     def __init__(self, message, original_error=None):
    ...
    1:     def __init__(self, message, payload=None):
               BadData.__init__(self, message)
    ...
    2: class BadHeader(BadSignature):
    ...
    1:     def __init__(self, message, payload=None, header=None,
    1:                  original_error=None):
               BadSignature.__init__(self, message, payload)
    ...
    2: class SignatureExpired(BadTimeSignature):
    ...
    2: class HMACAlgorithm(SigningAlgorithm):
    1:     """This class provides signature generation using HMACs."""
    ...
    1:     default_digest_method = staticmethod(hashlib.sha1)
       
    1:     def __init__(self, digest_method=None):
    3:         if digest_method is None:
                   digest_method = self.default_digest_method
    3:         self.digest_method = digest_method
    ...
    1:     default_digest_method = staticmethod(hashlib.sha1)
           ...
           #:
           #: .. versionadded:: 0.14
    1:     default_key_derivation = 'django-concat'
       
    1:     def __init__(self, secret_key, salt=None, sep='.', key_derivation=None,
    1:                  digest_method=None, algorithm=None):
    ...
    1:     def get_signature(self, value):
    ...
    1:     def verify_signature(self, value, sig):
    ...
    1:     def validate(self, signed_value):
    ...
    1:     def timestamp_to_datetime(self, ts):
    ...
    1:     def unsign(self, value, max_age=None, return_timestamp=False):
    ...
    1:     def validate(self, signed_value, max_age=None):
               """Just validates the given signed value.  Returns `True` if the
               signature exists and is valid, `False` otherwise."""
               try:
    ...
    1:     default_serializer = json
       
           #: The default :class:`Signer` class that is being used by this
           #: serializer.
           #:
           #: .. versionadded:: 0.14
    1:     default_signer = Signer
       
    1:     def __init__(self, secret_key, salt=b'itsdangerous', serializer=None,
    1:                  signer=None, signer_kwargs=None):
               self.secret_key = want_bytes(secret_key)
    ...
    1:     def load_payload(self, payload, serializer=None):
    ...
    1:     def make_signer(self, salt=None):
    ...
    1:     def dumps(self, obj, salt=None):
    ...
    1:     def dump(self, obj, f, salt=None):
               """Like :meth:`dumps` but dumps into a file.  The file handle has
               to be compatible with what the internal serializer expects.
               """
               f.write(self.dumps(obj, salt))
       
    1:     def loads(self, s, salt=None):
    ...
    1:     def load(self, f, salt=None):
               """Like :meth:`loads` but loads from a file."""
               return self.loads(f.read(), salt)
       
    1:     def loads_unsafe(self, s, salt=None):
    ...
    1:     def _loads_unsafe_impl(self, s, salt, load_kwargs=None,
    1:                            load_payload_kwargs=None):
    ...
    1:     def load_unsafe(self, f, *args, **kwargs):
    ...
    2: class TimedSerializer(Serializer):
           """Uses the :class:`TimestampSigner` instead of the default
           :meth:`Signer`.
    1:     """
       
    1:     default_signer = TimestampSigner
       
    1:     def loads(self, s, max_age=None, return_timestamp=False, salt=None):
               """Reverse of :meth:`dumps`, raises :exc:`BadSignature` if the
    ...
    1:     def loads_unsafe(self, s, max_age=None, salt=None):
               load_kwargs = {'max_age': max_age}
               load_payload_kwargs = {}
               return self._loads_unsafe_impl(s, salt, load_kwargs, load_payload_kwargs)
       
       
    2: class JSONWebSignatureSerializer(Serializer):
           """This serializer implements JSON Web Signature (JWS) support.  Only
           supports the JWS Compact Serialization.
    1:     """
       
    1:     jws_algorithms = {
    1:         'HS256': HMACAlgorithm(hashlib.sha256),
    1:         'HS384': HMACAlgorithm(hashlib.sha384),
    1:         'HS512': HMACAlgorithm(hashlib.sha512),
    1:         'none': NoneAlgorithm(),
           }
       
           #: The default algorithm to use for signature generation
    1:     default_algorithm = 'HS256'
       
    1:     default_serializer = compact_json
       
    1:     def __init__(self, secret_key, salt=None, serializer=None,
    1:                  signer=None, signer_kwargs=None, algorithm_name=None):
    ...
    1:     def load_payload(self, payload, return_header=False):
    ...
    1:     def make_header(self, header_fields):
               header = header_fields.copy() if header_fields else {}
               header['alg'] = self.algorithm_name
               return header
       
    1:     def dumps(self, obj, salt=None, header_fields=None):
    ...
    1:     def loads(self, s, salt=None, return_header=False):
    ...
    1:     def loads_unsafe(self, s, salt=None, return_header=False):
               kwargs = {'return_header': return_header}
               return self._loads_unsafe_impl(s, salt, kwargs, kwargs)
       
       
    2: class TimedJSONWebSignatureSerializer(JSONWebSignatureSerializer):
    ...
    1:     DEFAULT_EXPIRES_IN = 3600
       
    1:     def __init__(self, secret_key, expires_in=None, **kwargs):
    ...
    1:     def get_issue_date(self, header):
               rv = header.get('iat')
    ...
    1:     def load_payload(self, payload):
               decompress = False
